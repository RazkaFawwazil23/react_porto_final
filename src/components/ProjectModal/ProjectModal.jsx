            ...
            <div className="flex gap-3 mt-4">
              ...
              {project.liveDemo && (
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 font-semibold bg-gradient-to-r from-cyan-500 to-teal-500 p-3 px-5 rounded-full cursor-pointer border border-transparent hover:from-cyan-600 hover:to-teal-600 transition-all"
                >
                  <FiExternalLink />
                  <span>Live Demo</span>
                </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`${project.liveDemo ? 'flex-1' : 'w-full'} inline-flex items-center justify-center gap-2 font-semibold bg-violet-600 p-3 px-5 rounded-full cursor-pointer border border-transparent hover:bg-violet-700 transition-colors`}
              >
                <FiGithub />
