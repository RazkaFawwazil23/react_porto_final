        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Razka Fawwazil Hakim" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I’m Razka Fawwazil Hakim, a Computer Science student at Bina Nusantara University majoring in Web Development. I’m a full-stack web developer passionate about creating modern, high-performance, and user-friendly web applications. With over three years of experience and more than ten completed projects, I focus on building functional, scalable, and visually appealing digital solutions."
                  delay={150}
                  animateBy="words"
                  direction="top"
